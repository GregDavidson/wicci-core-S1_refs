...
#define RowColTag(r, c, t, n) RowColTypedInt32(CALL_  (r), (c), (t), (n))
// #define RowColTag0(r, c, t) RowColIfInt32(CALL_  (r), (c), (t), 0)
#define QueryTagType(p, a, t, n) SpxQueryInt32(CALL_  (p), (a), (t), (n))
#define QueryTag(p, a, t, n) SpxQueryTypedInt32(CALL_  (p), (a), (t), (n))
#define QueryTag0(p, a, t) SpxQueryTypedIfInt32(CALL_  (p), (a), (t), 0)
...
#define RowColId(r,c,t,n) ID_SUFFIX(RowColTypedInt)(CALL_ (r),(c),(t),(n))
// #define RowColId0(r,c,t) ID_SUFFIX(RowColIfInt)(CALL_ (r),(c),(t),0)
#define QueryIdType(p,a,t,n) ID_SUFFIX(SpxQueryInt)(CALL_ (p),(a),(t),(n))
#define QueryId(p,a,t,n) ID_SUFFIX(SpxQueryTypedInt)(CALL_ (p),(a),(t),(n))
#define QueryId0(p,a,t) ID_SUFFIX(SpxQueryTypedIfInt)(CALL_ (p),(a),(t),0)

#define UpdateIdType(p,a,t,n) ID_SUFFIX(SpxUpdateInt)(CALL_ (p),(a),(t),(n))
#define UpdateId(p,a,t,n) ID_SUFFIX(SpxUpdateTypedInt)(CALL_ (p),(a),(t),(n))
...
#define RowColRef(r,c,t,n) REF_SUFFIX(RowColTypedInt)(CALL_ (r),(c),(t),(n))
#define QueryRefType(p,a,t,n) REF_SUFFIX(SpxQueryInt)(CALL_ (p),(a),(t),(n))
#define QueryRef(p,a,t,n) REF_SUFFIX(SpxQueryTypedInt)(CALL_ (p),(a),(t),(n))

#define UpdateRefType(p,a,t,n) REF_SUFFIX(SpxUpdateInt)(CALL_ (p),(a),(t),(n))
#define UpdateRef(p,a,t,n) REF_SUFFIX(SpxUpdateTypedInt)(CALL_ (p),(a),(t),(n))
